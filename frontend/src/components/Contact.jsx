...
const Contact = () => {
  return (
    <div class="flex w-full bg-gray-400 min-h-screen justify-center px-2 items-center">
        <div 
            ...
            <div class="flex flex-col space-y-8 justify-between">
                <div class="flex flex-col"> 
                    ...
                    <div class="flex flex-col space-y-6">
                        ...
                        <div className='text-gray-500 flex justify-center'> <PhoneIcon className='w-[20px]' /></div>       
                           <ion-icon name="" class="text-teal-300 text-xl"></ion-icon>
                           <span>+233 (0)50 821 7315</span>
                        </div>
                        <div class="inline-flex space-x-2 items-center">
                        <div className='text-gray-500 flex justify-center'> <EnvelopeIcon className='w-[20px]' /></div>       
                          <ion-icon name="mail" class="text-teal-300 text-xl"></ion-icon>
                          <span>info@delconsultgh.com</span>
                        </div>
                        <div class="inline-flex space-x-2 items-center">
                        <div className='text-gray-500 flex justify-center'> <MapPinIcon className='w-[20px]' /></div>       
                          <ion-icon name="location" class="text-teal-300 text-xl"></ion-icon>
                          <span>GM -119-6531, Mountain View Community, Oyarifa-Accra</span>
                        </div>
                    </div>
                <div> 
            ...
            <div class="relative">
                ...
                <form action="" class="flex flex-col space-y-4">
                    <div>
                        ...
                        <input type="text" placeholder="Your name" class="ring-1 ring-gray-300 w-full rounded-md mt-2 px-4 py-2 outline-none focus:ring-2 focus:ring-gray-500"/>
                    </div>
                    <div>
