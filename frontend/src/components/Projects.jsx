    ...
    <div name='project' className='w-full my-32'>
        ...
        <div className='grid md:grid-cols-4 gap-8 px-12 text-center mt-20'>
                <div className='border py-8 rounded-xl shadow-xl hover:bg-gray-200'>
                    ...
                    <p className='text-xl mt-2 text-center'>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit</p>
                </div>
                <div  className='border py-8 rounded-xl shadow-xl hover:bg-gray-200' >
                   <div className='text-gray-500 flex justify-center'> 
                      <img className='h-48 min-h-0 rounded-md' src={images.lastp} alt="/" />
                   </div>
                   <p className='text-xl mt-2 text-center'>Phasellus faucibus scelerisque eleifend donec pretium. Lacus suspendisse faucibus interdum
                ...
                <div className='border py-8 rounded-xl shadow-xl hover:bg-gray-200' >
                    ...
                    <p className='text-xl text-center mt-2'>Tellus id interdum velit laoreet. At consectetur lorem donec massa sapien.</p>
                </div>
                <div className='border py-8 rounded-xl shadow-xl hover:bg-gray-200' >
                    <div className='text-gray-500 flex justify-center'> 
                      <img className='h-48 min-h-0 rounded-md' src={images.thirdp} alt="/" />
                    </div>
                    <p className='text-xl text-center mt-2'>Pellentesque elit eget gravida cum sociis natoque penatibus et. Hendrerit dolor magna eget est lorem</p>
                </div>
            </div>
    </div>
  )
